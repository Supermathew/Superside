...
from navigation.api.views import (
    ...
    SocialupdateView,tagdetailsView,UserFooterView,UsernavbarView,blogmetaView,BlogsListView,categoriesView,categoryheadingView,
    ...
    BlogauthorUpdateView,TagView,TagUpdateView,pricingView,EmailView,VideoUpdateUploadView,Factsview,blogmetaUpdateView,
